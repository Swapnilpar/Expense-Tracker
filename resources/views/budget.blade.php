...
@section('content')
    ...
    <body id="BudgetBody">
            ...
            <div class="row">
                ...
                <div class="col-md-4 leftsidebar bg-light p-3">
                    ...
                    <div class="budget-status my-3">
                        <h5>Budget Set: <h5 class="text-success">{{ $budgetAmount ?? '' }} &#8377; </h5>
                        </h5>
                        <h5>Remaining Budget: <h5 class="text-danger">{{ $AmountRemaining ?? '' }} &#8377; </h5>
                        </h5>
                    </div>
                    ...
                    <div class="container mt-3">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-8 text-center">
                                ...
                                <button class="btn btn-dark btn-lg" data-bs-toggle="modal"
                                    data-bs-target="#setBudgetModal">Set Budget</button>
                            </div>
        ...
        <!-- Set Budget Modal -->
        <div class="modal fade " id="setBudgetModal" tabindex="-1" aria-labelledby="setBudgetModalLabel"
            aria-hidden="true">
        ...
        {{-- script for budget Visualization --}}
        <script>
